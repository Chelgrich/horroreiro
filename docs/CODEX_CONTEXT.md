...
2. Movie editor: in progress; continue moving modal submit orchestration, Supabase insert/update sequencing, and post-save synchronization out of `app.js` after the current helper/relation/poster-save-plan split.
