...
2. Movie editor: in progress; continue moving modal submit orchestration and post-save synchronization out of `app.js` after the current helper/relation/poster-save-plan/movie-row/related-write split.
