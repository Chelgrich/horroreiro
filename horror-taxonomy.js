...
const CANON_TAG_META = {
  ...
  'Джинн': createCanonTagMeta({
    tier: "standard",
    confidence: "stable",
    status: CANON_TAG_STATUSES.stable,
    role: CANON_TAG_ROLES.threat_type,
    families: ['Источник угрозы', 'Переосмысление мифа', 'Ритуальный механизм'],
    lanes: ['supernatural_entity_lane', 'folk_myth_lane', 'ritual_occult_lane'],
    useWhen: 'Центральная угроза прямо связана с джинном, ифритом или близкой исламской/ближневосточной сверхъестественной сущностью.',
    avoidWhen: 'Есть просто демоническая, призрачная или неопределённая злая сущность без привязки к джинну/ифриту или соответствующему мифологическому контексту.',
    examples: ['Ифрит 2: Новая история'],
    counterExamples: []
  }),
...
const CANON_AFFINITY = {
  ...
  'Джинн': {
    ...
    'Мифическое существо': 0.3,
    'Демоническая сущность': 0.2,
    'Расплата за желание': 0.18,
    'Оккультная сделка': 0.15
  },
  ...
  'Фолк-хоррор': [
    {
      ...
      tags: ['Фольклорная сущность', 'Джинн', 'Мифическое существо', 'Ведьмовство', 'Оккультный ритуал', 'Чёрная магия', 'Опасный культ']
    }
  ],
  'Религиозный хоррор': [
    {
      label: 'религиозная или культовая механика',
      tags: ['Религиозный фундаментализм', 'Демоническая сущность', 'Джинн', 'Демоническая одержимость', 'Экзорцизм', 'Оккультный ритуал', 'Опасный культ', 'Расплата за желание', 'Правило расплаты']
    }
  ]
};
