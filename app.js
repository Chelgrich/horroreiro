...
function getDirectorPlaceholderSvgHtml(director, iconClassName = 'director-page-photo-placeholder-icon') {
  ...
  const iconPaths = isFemale
    ...
    : `
        <path
          fill="currentColor"
          d="M47.9 6C34.2 6 25 15.1 25 28.9v7.8c-3.6.7-6.3 4.2-6.3 8.3 0 4.2 2.8 7.7 6.6 8.3 2.1 7.4 7.2 13.2 14.2 15.6v3C23.4 74.7 11.2 82 8.6 92h78.8c-2.6-10-14.8-17.3-30.9-20.1v-3c7-2.4 12.1-8.2 14.2-15.6 3.8-.6 6.6-4.1 6.6-8.3 0-4.1-2.7-7.6-6.3-8.3v-7.8C71 15.1 61.8 6 48.1 6h-.2Z"
        />
      `;
