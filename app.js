...
function getDirectorPlaceholderSvgHtml(director, iconClassName = 'director-page-photo-placeholder-icon') {
  ...
  const iconPaths = isFemale
    ? `
        <path
          fill="currentColor"
          d="M47.9 6C33.2 6 23.5 16.4 23.5 31.9v26.5L13 68.1h18.5c-11.8 4-20.4 12.2-22.9 23.9h78.8c-2.5-11.7-11.1-19.9-22.9-23.9H83l-10.5-9.7V31.9C72.5 16.4 62.8 6 48.1 6h-.2Zm0 15.3c6.8 7.5 14.1 11 22 10.5-.1 14.9-8 27-21.9 27s-21.8-12.1-21.9-27c7.8.5 15.1-3 21.8-10.5Z"
        />
      `
    : `
        <path
          fill="currentColor"
          d="M47.9 6C34.2 6 25 15.1 25 28.9v7.8c-3.6.7-6.3 4.2-6.3 8.3 0 4.2 2.8 7.7 6.6 8.3 2.1 7.4 7.2 13.2 14.2 15.6v3C23.4 74.7 11.2 82 8.6 92h78.8c-2.6-10-14.8-17.3-30.9-20.1v-3c7-2.4 12.1-8.2 14.2-15.6 3.8-.6 6.6-4.1 6.6-8.3 0-4.1-2.7-7.6-6.3-8.3v-7.8C71 15.1 61.8 6 48.1 6h-.2Zm0 11.5c8.9 0 15.6 5.4 18.3 13.6-4.2 4.2-10.2 6.2-18.2 6.2-5.3 0-10.3-.7-15-2.2.7-10.3 6.4-17.6 14.9-17.6Z"
        />
      `;
