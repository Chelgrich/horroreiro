  ...
  const iconPaths = isFemale
    ? `
        <path
          ...
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M14 90c1.1-17.3 14.9-29.6 34-29.6S80.9 72.7 82 90H14Zm25.1-34.7h17.8v10.4c-2.6 1.4-5.5 2.1-8.9 2.1s-6.3-.7-8.9-2.1V55.3Zm-14.8 5.1C18.6 49 18.2 27.9 24.6 16.5 29.4 7.9 37.6 4 48 4s18.6 3.9 23.4 12.5c6.4 11.4 6 32.5.3 43.9l-11.6-3.9c4.4-7.5 5.9-17.6 5.3-27.4-4.7 4.8-12.1 7.2-22.8 7.2-4.7 0-8.8-.4-12.2-1.2-.3 7.8 1.3 15.7 5.4 21.4l-11.5 3.9ZM48 25.6C43.8 32 37 35 27.8 34.6c.2 4.8.8 9.4 1.9 13.3 2.7 9.9 9.7 16.9 18.3 16.9s15.6-7 18.3-16.9c1.3-4.8 1.9-10.5 1.6-16.2-5.6 2.9-12.1 4.1-19.9 4.1-3 0-5.8-.2-8.5-.5 3.4-1.7 6.2-4.9 8.5-9.7Z"
        />
      `
    : `
        <path
          ...
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M14 90c1-17.7 14.7-30.4 34-30.4S81 72.3 82 90H14Zm25-33h18v11.1c-2.6 1.2-5.6 1.8-9 1.8s-6.4-.6-9-1.8V57Zm-8.9-5.6c3.5 12.1 10.4 19 17.9 19s14.4-6.9 17.9-19c4.2-.8 7.2-5.2 7.2-10.3 0-4.6-2.4-8.4-6.1-9.9.8-8.2-.4-14.2-4.1-18.4C59 8.3 52.6 6.2 43.6 6.2 29 6.2 20.6 14.6 20.6 29.8c0 .5 0 1 .1 1.5-3.5 1.5-5.8 5.3-5.8 9.8 0 5.1 3 9.5 7.2 10.3ZM48 29.1c8.5 0 14.8-2.1 19.4-6.1 1.1 4.2.9 9.4.4 14.8-.2 2.4-.6 4.8-1.1 7.1-2.6 11.8-9.7 19.6-18.7 19.6s-16.1-7.8-18.7-19.6c-.5-2.3-.9-4.7-1.1-7.1-.2-2.1-.3-4.1-.2-6 4.6-1.5 8.3-4.2 11.4-8 1.7 3.3 4.5 5.3 8.6 5.3Z"
        />
      `;
