...
function renderUserPage(data) {
  ...
  const profileSettingsButtonHtml = canEditDisplayName
    ? `
      ...
      >
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path class="settings-gear-fill" fill-rule="evenodd" clip-rule="evenodd" d="M9.35 1.5h5.3l.55 3.7c.43.16.85.34 1.24.56l3.05-2.24 3.75 3.75-2.24 3.05c.22.39.4.81.56 1.24l3.7.55v5.3l-3.7.55c-.16.43-.34.85-.56 1.24l2.24 3.05-3.75 3.75-3.05-2.24c-.39.22-.81.4-1.24.56l-.55 3.7h-5.3l-.55-3.7a9.2 9.2 0 0 1-1.24-.56l-3.05 2.24-3.75-3.75 2.24-3.05a9.2 9.2 0 0 1-.56-1.24l-3.7-.55v-5.3l3.7-.55c.16-.43.34-.85.56-1.24L.76 7.27l3.75-3.75 3.05 2.24c.39-.22.81-.4 1.24-.56l.55-3.7ZM12 15.9a3.9 3.9 0 1 0 0-7.8 3.9 3.9 0 0 0 0 7.8Z"></path>
        </svg>
      </button>
    `
    : '';
