...
function getDirectorPlaceholderSvgHtml(director, iconClassName = 'director-page-photo-placeholder-icon') {
  ...
  const faceLine = `
        <path
          ...
          d="M32 32c0-8.1 6.2-14 16-14s16 5.9 16 14c0 14.2-6.5 24-16 24S32 46.2 32 32Z"
        />
      `;
  const iconPaths = isFemale
    ? `
        <path
          fill="currentColor"
          d="M17 90V78c0-10.7 12.7-18.6 31-18.6s31 7.9 31 18.6v12H17Z"
        />
        <path
          fill="currentColor"
          d="M39 52h18v14H39V52Z"
        />
        <path
          fill="currentColor"
          d="M48 8c-12.2 0-20 8.6-20 22v12c0 12.8 8.5 23 20 23s20-10.2 20-23V30c0-13.4-7.8-22-20-22Z"
        />
        <path
          fill="currentColor"
          d="M25.8 34.4c-3 0-5.5 3.3-5.5 7.3s2.5 7.3 5.5 7.3h3.1V34.4h-3.1Zm44.4 0h-3.1V49h3.1c3 0 5.5-3.3 5.5-7.3s-2.5-7.3-5.5-7.3Z"
        />
        <path
          fill="currentColor"
          d="M24 56.5c-2-6.3-3-14.1-3-23C21 16.7 31.7 6 48 6s27 10.7 27 27.5v24.2c2.8 1.7 6.4 2.7 10.4 3-4.2 4.1-10.9 5.7-19.7 4.6V31.7c-7.6.8-14.1-1.9-19.7-8.1-4.3 6-10.3 9.1-18 9.5v23.4H24Z"
        />
        ${faceLine}
      `
    : `
        ...
        <path
          fill="currentColor"
          d="M27.7 31.6C28.4 16.5 36.3 8 48 8c10.8 0 18.4 7.2 19.8 20.1-4.7 3.5-10.8 5.2-18.3 5.2-7.2 0-14.5-1.2-21.8-3.7v2Z"
        />
        ${faceLine}
      `;
