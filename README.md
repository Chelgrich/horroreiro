...
- `custom-select.js` — кастомные select-контролы для каталога; на деталках фильма подгружается по требованию перед открытием модалки
- `app.js` — основная логика приложения
- `following-page.js` — lazy-модуль страницы `/following`
